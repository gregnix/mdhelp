...
Gefixt. mdpdf-0.2.tm in mdhelp/vendors/tm/ und
...
### Fix 2026-03-07: Seitenumbruch implementiert

**Problem:** Tabellen wurden nie ueber Seitengrenzen gebrochen.
Vertikale Linien wurden erst nach allen Zeilen gezeichnet mit
`tableTopY` von Seite 1 und `tableBotY` von Seite 2 -- falsche
...
- Spaltenbreiten proportional berechnet (kein automatischer Zeilenumbruch)

### Status

Seitenumbruch **gefixt 2026-03-07**. Zeilenumbruch in Zellen: bekannt, niedrige Prioritaet.
...
| 8 | Tabellen-Seitenumbruch | Mittel | **Gefixt 2026-03-07** |
